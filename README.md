...
HTML básico para que personas puedan registrarse a un evento online. Complementariamente, a lo largo del sprint irás añadiendo distintas funcionalidades, como por ejemplo, cómo registrarse con Google o integrar un proveedor de pago. Debajo te dejamos un mock de la estructura que deberás armar. ¡Esto luego te servirá para replicar los conocimientos adquiridos y armar tu Sprint Project individualmente!
...
2. Ingresar a la carpeta creada y desde la consola ejecutar:
   `git clone https://github.com/felipemoralesquerol/aca-dwbe-sp4-m57-evento-online`
...
- Descarga y ejecuta localmente la colección https://github.com/felipemoralesquerol/aca-dwbe-sp4-m57-evento-online/blob/master/api/postman/aca-dwbe-sp4-m57-evento-online.postman_collection.json
